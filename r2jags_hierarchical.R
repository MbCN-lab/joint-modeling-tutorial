...
maps=apply(out$DeltaTheta,c(1,2),mean)
...
text(.5,.5,"MAP Estimate",srt=90,cex=cex.big)
...
text(3.1,.7,"R = ",cex=cex.tiny) #insert correlation coefficient from line 102
...
text(2.2,-2.5,"R = ",cex=cex.tiny) # insert correlation coefficient from line 110
